...
export const zones = [
  {id:'foret',name:'Forêt de Débutant',element:'wind',levelMin:1,levelMax:15,requiredLevel:1,requiredRegionalBoss:null,regionalBossId:'wolf_king',enterStepCost:0,travelKm:0,themeColor:'#22c55e',accent:'#86efac',desc:'Une forêt sombre et silencieuse. Les sentiers serpentent entre des arbres millénaires.',bgImage:'/environnements/forest-dashboard.png',combatBgImage:'/environnements/forest-combat.png',preSessionBgImage:'/environnements/forest-presession.png',svgKey:'forest'},
  ...
  {id:'caverne',name:'Caverne de Cristal',element:'water',levelMin:31,levelMax:50,requiredLevel:28,requiredRegionalBoss:'corrupted_dryad',regionalBossId:null,enterStepCost:0,travelKm:5,themeColor:'#22d3ee',accent:'#67e8f9',desc:'Profondeurs scintillantes. Les cristaux résonnent d\'une magie ancienne.',bgImage:'/environnements/cavern-dashboard.png',combatBgImage:'/environnements/cavern-combat.png',preSessionBgImage:'/environnements/cavern-presession.png',svgKey:'crystal'}
];
